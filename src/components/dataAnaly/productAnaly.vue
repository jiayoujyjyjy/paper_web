  ...
  <div class="goodsAnalyPage">
    ...
    <div class="order-container">
      <div class="order-amount-container">
        <span class="little-title">品类成交金额TOP10</span>
        <div id="orderNumberChart" class="chart-container"></div>
      </div>
      <div class="order-time-container">
        <span class="little-title">商品成交金额TOP10</span>
...
export default {
  ...
  methods: {
    ...
    */
    // 商品分析
    backQuePaperAnalysis: function () {
      sessionSetStore('backName', '商品分析')
      back.quePaperAnalysis(this.param)
        .then(function (res) {
          console.log(res)
          this.paperTypeList = res.data.paperTypeList
          this.paperList = res.data.paperList
          this.loaddiagram('orderNumberChart', res.data.paperTypeList)
          this.loaddiagram('orderTimerChart', res.data.paperList)
        }.bind(this))
