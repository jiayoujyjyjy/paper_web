...
export default {
  data () {
    return {
      ...
      tableMaxHeght: document.body.clientHeight - 40 - 20 - 40 - 40 - 42 - 45 + 13 // ===tableDiv的高度
    }
  },
  created: function () {
    // session获取登录者关键参数
  ...
  mounted: function () {
    ...
    $('.tableDiv').height(mainHeight - 40 - 42 - 45 + 13) // serachDiv 几台设备Div footer +13的原因是element的控件boder-sizing为content
  },
